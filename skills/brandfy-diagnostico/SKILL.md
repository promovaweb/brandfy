...
- **Resumo final:** registrar cobertura, conflitos, prioridades e próximas
  skills.
...
5. Comparar as respostas da entrevista com a prática observada. Marcar
   convergência, conflito e ausência de comprovação.
6. Preencher `.brandfy/diagnostico.md` com comprovações e caminhos relativos.
...
público. Para cada achado, registrar comprovação, impacto, urgência, dependência
