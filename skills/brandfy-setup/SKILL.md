...
3. Abrir `.brandfy/config.yaml` e ajustar nome, país, idioma, destino e fase da
   marca com o usuário.
4. Preencher `.brandfy/brief.md` apenas com fatos confirmados. Manter lacunas
   explícitas quando faltar informação.
5. Conferir o bloco delimitado por `brandfy:consumer` no `AGENTS.md`.
6. Executar:
